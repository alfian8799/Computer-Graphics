...
void drawScene() {
    ...
    if (healthCount == 0) {
        ...
        drawText(gameOverText.data(), gameOverText.size(), -0.3f, 0.6f);
        ...
        drawText(text.data(), text.size(), -0.2f, 0.5f);
...
// kontrol r mulai ulang permainan
...
void update(int value) {
    ...
    restartIfGameOver();
    glutTimerFunc(6, update, 0); // Memberitahu GLUT untuk memanggil fungsi update lagi dalam 6 milidetik
}
