...
void myKeyboard(unsigned char key, int x, int y) {
    if (key == 'q') {
        ...
        colorS = 1; // Merubah warna objek menjadi merah
    }
    else if (key == 'g') {
        colorS = 2; // Merubah warna objek menjadi hijau
    }
    else if (key == 'b') {
        colorS = 3; // Merubah warna objek menjadi biru
    }
    else if (key == 'y') {
        colorS = 4; // Merubah warna objek menjadi kuning
